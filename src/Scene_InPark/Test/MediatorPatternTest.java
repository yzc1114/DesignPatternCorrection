...
public class MediatorPatternTest {
    ...
    public static void mediatorPatternTest(){
        ...
        //实例化游客
        Tourist tourist1 = new Tourist("张一");
        Tourist tourist2 = new Tourist("张二");
        Tourist tourist3 = new Tourist("张三");
        ...
        String message="XXXX启事";
        //广播播报
        tourist1.lookingFor(message, broadcast);
